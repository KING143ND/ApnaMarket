# Generated by Django 3.2 on 2023-05-27 19:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='customer',
            name='address',
            field=models.CharField(choices=[('unknown', 'unknown'), ('Home', 'Home'), ('Work', 'Work')], default='unknown', max_length=15),
        ),
        migrations.AlterField(
            model_name='customer',
            name='gender',
            field=models.CharField(choices=[('unknown', 'unknown'), ('Male', 'Male'), ('Female', 'Female'), ('Not Specified', 'Not Specified')], default='unknown', max_length=15),
        ),
        migrations.AlterField(
            model_name='customer',
            name='state',
